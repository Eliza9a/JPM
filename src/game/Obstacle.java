...
public class Obstacle extends Walker implements StepListener{

    private float left, right;
    private static SoundClip destroySound;

    private static final BodyImage iceCubeImage = new BodyImage("assets/icecube.png", 4);
    private static final Shape iceCubeShape = new BoxShape(2, 2);
